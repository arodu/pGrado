...
--
-- Servidor: localhost
-- Tiempo de generación: 16-01-2017 a las 18:40:57
...
--
-- Estructura de tabla para la tabla `descripcion_logs`
--
...
--
-- Volcado de datos para la tabla `descripcion_logs`
--
...
--
-- Estructura de tabla para la tabla `descripcion_tutors`
--
...
--
-- Estructura de tabla para la tabla `descripcion_usuarios`
--
...
(2, 1, 3, NULL, '2016-11-30 20:35:06', NULL),
(3, 1, 3, NULL, '2017-01-14 18:52:45', NULL),
(4, 1, 3, NULL, '2017-01-16 11:44:30', NULL);
...
--
-- Estructura de tabla para la tabla `perfils_usuarios`
--
...
--
-- Volcado de datos para la tabla `perfils_usuarios`
--
...
--
-- Estructura de tabla para la tabla `principal_mensajes`
--
...
--
-- Estructura de tabla para la tabla `principal_planillas`
--
...
--
-- Estructura de tabla para la tabla `tipo_autors`
--
...
--
-- Volcado de datos para la tabla `tipo_autors`
--
...
--
-- Estructura de tabla para la tabla `tipo_jurados`
--
...
--
-- Volcado de datos para la tabla `tipo_jurados`
--
...
--
-- Estructura de tabla para la tabla `tipo_mensajes`
--
...
--
-- Volcado de datos para la tabla `tipo_mensajes`
--
...
--
-- Estructura de tabla para la tabla `tipo_planillas`
--
...
--
-- Volcado de datos para la tabla `tipo_planillas`
--
...
--
-- Indices de la tabla `descripcion_logs`
--
...
--
-- Indices de la tabla `descripcion_tutors`
--
...
--
-- Indices de la tabla `descripcion_usuarios`
--
...
--
-- Indices de la tabla `perfils_usuarios`
--
...
--
-- Indices de la tabla `principal_mensajes`
--
...
--
-- Indices de la tabla `principal_planillas`
--
...
--
-- Indices de la tabla `tipo_autors`
--
...
--
-- Indices de la tabla `tipo_jurados`
--
...
--
-- Indices de la tabla `tipo_mensajes`
--
...
--
-- Indices de la tabla `tipo_planillas`
--
...
ALTER TABLE `descargas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `descripcion_logs`
--
ALTER TABLE `descripcion_logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT de la tabla `descripcion_tutors`
--
ALTER TABLE `descripcion_tutors`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `descripcion_usuarios`
--
ALTER TABLE `descripcion_usuarios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `perfils_usuarios`
--
ALTER TABLE `perfils_usuarios`
...
ALTER TABLE `planillas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `principal_mensajes`
--
ALTER TABLE `principal_mensajes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `principal_planillas`
--
ALTER TABLE `principal_planillas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `tipo_autors`
--
ALTER TABLE `tipo_autors`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `tipo_jurados`
--
ALTER TABLE `tipo_jurados`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `tipo_mensajes`
--
ALTER TABLE `tipo_mensajes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `tipo_planillas`
--
ALTER TABLE `tipo_planillas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
