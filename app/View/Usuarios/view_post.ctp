<?php // ----------------- HEADER ------------------- ?> 
    <?php
        $this->assign('title-page', '<i class="fa fa-user fa-fw"></i> Perfil de Usuario <small>'.$userInfo['nombre'].'</small>');
		...
		<div class="box user-foto">
			...
			<div class="box-body text-center">
				<div class="img-user-foto">
					...
					<?php 
						$user_foto = $this->element('usuario/avatar',array('foto' => $userInfo['foto']));
					...
					<div class="row">
						...
						<div class="col-md-4">
							<dl class="">
								...
								<dt><?php echo __('Teléfono Trabajo'); ?></dt>
								<dd>
									<?php echo h($usuario['DescripcionUsuario']['telf_trab']); ?>
									&nbsp;
								</dd>
								...
								<dt><?php echo __('Título Obtenido'); ?></dt>
								<dd>
									<?php echo h($usuario['DescripcionUsuario']['titulo_obtenido']); ?>
									&nbsp;
								</dd>
								<dt><?php echo __('Profesión'); ?></dt>
								<dd>
									<?php echo h($usuario['DescripcionUsuario']['profesion']); ?>
									&nbsp;
								</dd>
								<dt><?php echo __('Institución donde Labora'); ?></dt>
								<dd>
									<?php echo h($usuario['DescripcionUsuario']['inst_labora']); ?>
									&nbsp;
								</dd>
								<dt><?php echo __('Nivel Académico'); ?></dt>
								<dd>
									<?php echo h($usuario['DescripcionUsuario']['nivel_academico']); ?>
									&nbsp;
								</dd>
								<dt><?php echo __('Resumen Curricular'); ?></dt>
								<dd>
									<?php echo h($usuario['DescripcionUsuario']['resumen_curricular']); ?>
									&nbsp;
								</dd>
							</dl>
						</div>
