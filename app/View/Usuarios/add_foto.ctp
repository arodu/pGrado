<?php // ----------------- HEADER ------------------- ?>
    <?php
        $this->assign('title-page', '<i class="fa fa-crop fa-fw"></i> Cambiar Foto de Usuario <small>avatar</small>');

        $bc = array(
            'items'=>array(
                    0 => array('title'=>'Perfil de Usuario','url'=>'/usuarios/index'),
                ),
            'config'=>array('activo'=>'Cambiar Foto de Usuario')
            );
