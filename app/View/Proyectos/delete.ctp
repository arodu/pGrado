	...
	<div class="modal-content">
        ...
        <br/>
				...
				<?php echo $this->bsForm->create('Proyecto', array('class'=>'')); ?>
					...
					<?php echo $this->bsForm->input('Proyecto.user_password', array('label'=>'Por seguridad, ingrese la contraseña del usuario <em>'.$userInfo['nombre'].'</em>', 'required'=>true, 'type'=>'password')); ?>
					<hr/>
