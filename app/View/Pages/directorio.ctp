					...
					<?php foreach ($usuarios as $usuario): ?>
						<tr>
							<td>
								...
								$user_foto = $this->element('usuario/avatarXXS',array('foto' => $usuario['Usuario']['foto']));

								echo $this->Html->image($user_foto,array('class'=>'img-responsive img-circle','style'=>'margin: auto; width:25px'));
								?>
							</td>
