<div class="grupos index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $grupo['Grupo']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $grupo['Grupo']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
