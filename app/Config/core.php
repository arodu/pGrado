 ...
 * Google analytics:
 * ejemplo
 * Configure::write('google_analytics_code','UA-58487941-1');
 * 		Detener analisis:
 * Configure::write('google_analytics_code',false);
 */
	Configure::write('google_analytics_code',false);
...
/**
 * Tipo de Sistema (Informatica, Postgrado)
 */
	//Configure::write('Sistema.tipo', 'inf');
	Configure::write('Sistema.tipo', 'inf');
 ...
 */
	Configure::write('Security.salt', 'DYh3b23qeeeyJfI5yiwee2weeoop33guujughubsWwdvniRi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '7623448565639887674989645');
...
if( Configure::read('Sistema.tipo') == 'post' ){ Configure::load('app/app_pos'); }
