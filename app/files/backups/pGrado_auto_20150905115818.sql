-- Database: `grados_base5_testing`
-- Generation time: Sat 5th Sep 2015 11:58:18
...
CREATE TABLE `archivos` (
  ...
  CONSTRAINT `archivos_ibfk_1` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`)
...
CREATE TABLE `autors` (
  ...
  CONSTRAINT `autors_ibfk_1` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `autors_ibfk_10` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `autors_ibfk_11` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `autors_ibfk_12` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `autors_ibfk_13` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `autors_ibfk_14` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `autors_ibfk_15` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `autors_ibfk_16` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `autors_ibfk_17` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `autors_ibfk_18` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `autors_ibfk_19` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `autors_ibfk_2` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `autors_ibfk_20` FOREIGN KEY (`tipo_autor_id`) REFERENCES `tipo_autors` (`id`),
  CONSTRAINT `autors_ibfk_21` FOREIGN KEY (`tipo_autor_id`) REFERENCES `tipo_autors` (`id`),
  CONSTRAINT `autors_ibfk_22` FOREIGN KEY (`tipo_autor_id`) REFERENCES `tipo_autors` (`id`),
  CONSTRAINT `autors_ibfk_23` FOREIGN KEY (`tipo_autor_id`) REFERENCES `tipo_autors` (`id`),
  CONSTRAINT `autors_ibfk_24` FOREIGN KEY (`tipo_autor_id`) REFERENCES `tipo_autors` (`id`),
  CONSTRAINT `autors_ibfk_25` FOREIGN KEY (`tipo_autor_id`) REFERENCES `tipo_autors` (`id`),
  CONSTRAINT `autors_ibfk_26` FOREIGN KEY (`tipo_autor_id`) REFERENCES `tipo_autors` (`id`),
  CONSTRAINT `autors_ibfk_27` FOREIGN KEY (`tipo_autor_id`) REFERENCES `tipo_autors` (`id`),
  CONSTRAINT `autors_ibfk_3` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `autors_ibfk_4` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `autors_ibfk_5` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `autors_ibfk_6` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `autors_ibfk_7` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `autors_ibfk_8` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `autors_ibfk_9` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;

INSERT INTO autors VALUES('12','3','1','1','2015-08-16 17:14:56','2015-08-16 17:14:56','1');
INSERT INTO autors VALUES('13','3','4','2','2015-08-16 17:14:56','2015-08-16 17:14:56','');
INSERT INTO autors VALUES('14','4','1','1','2015-08-30 18:16:20','2015-08-30 18:16:20','1');
...
INSERT INTO categorias VALUES('1','1',NULL,'Sistemas Web','','1','2','1');
INSERT INTO categorias VALUES('2','1',NULL,'Redes y Telecomunicaciones','','3','4','1');
INSERT INTO categorias VALUES('3','1',NULL,'Auditoria de Sistemas','','5','6','1');
INSERT INTO categorias VALUES('4','1',NULL,'Software Educativo','','7','8','1');
INSERT INTO categorias VALUES('5','1',NULL,'Inteligencia Artificial','','9','10','1');
INSERT INTO categorias VALUES('6','1',NULL,'Sistemas de Información','','11','12','1');
...
CREATE TABLE `categorias_usuarios` (
  ...
  KEY `usuario_id` (`usuario_id`),
  CONSTRAINT `categorias_usuarios_ibfk_1` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `categorias_usuarios_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `comentarios` (
  ...
  KEY `usuario_id` (`usuario_id`),
  KEY `proyecto_id` (`proyecto_id`),
  CONSTRAINT `comentarios_ibfk_1` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `descripcion_tutors` (
  ...
  PRIMARY KEY (`id`),
  KEY `usuario_id` (`usuario_id`),
  CONSTRAINT `descripcion_tutors_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE `descripcion_usuarios` (
  ...
  PRIMARY KEY (`id`),
  KEY `usuario_id` (`usuario_id`),
  CONSTRAINT `descripcion_usuarios_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `descripcion_usuarios_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `descripcion_usuarios_ibfk_3` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `descripcion_usuarios_ibfk_4` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `descripcion_usuarios_ibfk_5` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `descripcion_usuarios_ibfk_6` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `descripcion_usuarios_ibfk_7` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `descripcion_usuarios_ibfk_8` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `descripcion_usuarios_ibfk_9` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`)
...
CREATE TABLE `escenarios` (
  ...
  KEY `proyecto_id` (`proyecto_id`),
  KEY `nombre` (`nombre`),
  CONSTRAINT `escenarios_ibfk_1` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `escenarios_ibfk_2` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `escenarios_ibfk_3` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `escenarios_ibfk_4` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `escenarios_ibfk_5` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `escenarios_ibfk_6` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `escenarios_ibfk_7` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `escenarios_ibfk_8` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `escenarios_ibfk_9` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

INSERT INTO escenarios VALUES('3','3','','','','','','','','2015-08-16 17:14:57');
INSERT INTO escenarios VALUES('4','4','','','','','','','','2015-08-30 18:16:21');
...
INSERT INTO grupos VALUES('1','Proyecto de Grado I (2015-1)','1','1','{\"fases\":{\"5\":{\"no_consj_area\":\"3\",\"fecha_consj_area\":\"13-06-2015\",\"fecha_comun\":\"13-06-2015\"},\"1\":{\"no_consj_area\":\"3\",\"fecha_consj_area\":\"14-06-2015\",\"fecha_comun\":\"14-06-2015\"}}}');
...
CREATE TABLE `jurados` (
  ...
  CONSTRAINT `jurados_ibfk_1` FOREIGN KEY (`tipo_jurado_id`) REFERENCES `tipo_jurados` (`id`),
  CONSTRAINT `jurados_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `jurados_ibfk_3` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `logs` (
  ...
  CONSTRAINT `logs_ibfk_1` FOREIGN KEY (`descripcion_log_id`) REFERENCES `descripcion_logs` (`id`)
...
INSERT INTO logs VALUES('56','1','3',NULL,'2015-07-14 21:06:25',NULL);
INSERT INTO logs VALUES('57','1','3',NULL,'2015-07-14 21:17:07',NULL);
INSERT INTO logs VALUES('58','1','3',NULL,'2015-07-14 21:20:09',NULL);
INSERT INTO logs VALUES('59','1','3',NULL,'2015-07-15 15:03:19',NULL);
INSERT INTO logs VALUES('60','1','3',NULL,'2015-07-15 15:05:54',NULL);
INSERT INTO logs VALUES('61','1','3',NULL,'2015-07-15 15:14:12',NULL);
INSERT INTO logs VALUES('62','1','3',NULL,'2015-07-24 11:27:15',NULL);
INSERT INTO logs VALUES('63','1','1','21','2015-07-24 11:29:54','code:Comentario.created.add;');
INSERT INTO logs VALUES('64','1','3',NULL,'2015-08-15 08:44:08',NULL);
INSERT INTO logs VALUES('65','1','14','12','2015-08-15 08:52:32',NULL);
INSERT INTO logs VALUES('66','1','19','12','2015-08-15 08:52:54',NULL);
INSERT INTO logs VALUES('67','1','19','1','2015-08-15 08:53:39',NULL);
INSERT INTO logs VALUES('68','1','19','8','2015-08-15 08:53:39',NULL);
INSERT INTO logs VALUES('69','1','19','9','2015-08-15 08:53:39',NULL);
INSERT INTO logs VALUES('70','1','20','1','2015-08-15 08:53:39',NULL);
INSERT INTO logs VALUES('71','1','20','4','2015-08-15 08:53:40',NULL);
INSERT INTO logs VALUES('72','1','20','5','2015-08-15 08:53:40',NULL);
INSERT INTO logs VALUES('73','1','20','6','2015-08-15 08:53:40',NULL);
INSERT INTO logs VALUES('74','1','20','7','2015-08-15 08:53:40',NULL);
INSERT INTO logs VALUES('75','1','20','8','2015-08-15 08:53:40',NULL);
INSERT INTO logs VALUES('76','1','20','9','2015-08-15 08:53:40',NULL);
INSERT INTO logs VALUES('77','1','20','10','2015-08-15 08:53:40',NULL);
INSERT INTO logs VALUES('78','1','20','11','2015-08-15 08:53:40',NULL);
INSERT INTO logs VALUES('79','1','20','12','2015-08-15 08:53:41',NULL);
INSERT INTO logs VALUES('80','1','20','13','2015-08-15 08:53:41',NULL);
INSERT INTO logs VALUES('81','1','20','17','2015-08-15 08:53:41',NULL);
INSERT INTO logs VALUES('82','1','1','1','2015-08-15 08:53:41','code:Comentario.delete;');
INSERT INTO logs VALUES('83','1','1','2','2015-08-15 08:53:41','code:Comentario.delete;');
INSERT INTO logs VALUES('84','1','1','3','2015-08-15 08:53:41','code:Comentario.delete;');
INSERT INTO logs VALUES('85','1','1','4','2015-08-15 08:53:41','code:Comentario.delete;');
INSERT INTO logs VALUES('86','1','1','5','2015-08-15 08:53:41','code:Comentario.delete;');
INSERT INTO logs VALUES('87','1','1','6','2015-08-15 08:53:42','code:Comentario.delete;');
INSERT INTO logs VALUES('88','1','1','7','2015-08-15 08:53:42','code:Comentario.delete;');
INSERT INTO logs VALUES('89','1','1','13','2015-08-15 08:53:42','code:Comentario.delete;');
INSERT INTO logs VALUES('90','1','1','14','2015-08-15 08:53:42','code:Comentario.delete;');
INSERT INTO logs VALUES('91','1','1','15','2015-08-15 08:53:42','code:Comentario.delete;');
INSERT INTO logs VALUES('92','1','1','16','2015-08-15 08:53:42','code:Comentario.delete;');
INSERT INTO logs VALUES('93','1','1','17','2015-08-15 08:53:42','code:Comentario.delete;');
INSERT INTO logs VALUES('94','1','1','18','2015-08-15 08:53:42','code:Comentario.delete;');
INSERT INTO logs VALUES('95','1','1','19','2015-08-15 08:53:42','code:Comentario.delete;');
INSERT INTO logs VALUES('96','1','1','20','2015-08-15 08:53:43','code:Comentario.delete;');
INSERT INTO logs VALUES('97','1','1','21','2015-08-15 08:53:43','code:Comentario.delete;');
INSERT INTO logs VALUES('98','1','1','145','2015-08-15 08:53:43','code:Archivo.delete;');
INSERT INTO logs VALUES('99','1','1','146','2015-08-15 08:53:43','code:Archivo.delete;');
INSERT INTO logs VALUES('100','1','1','147','2015-08-15 08:53:43','code:Archivo.delete;');
INSERT INTO logs VALUES('101','1','1','10','2015-08-15 08:53:43','code:Jurado.delete;');
INSERT INTO logs VALUES('102','1','1','11','2015-08-15 08:53:43','code:Jurado.delete;');
INSERT INTO logs VALUES('103','1','1','12','2015-08-15 08:53:44','code:Jurado.delete;');
INSERT INTO logs VALUES('104','1','1','16','2015-08-15 08:53:44','code:Jurado.delete;');
INSERT INTO logs VALUES('105','1','1','18','2015-08-15 08:53:44','code:Jurado.delete;');
INSERT INTO logs VALUES('106','1','1','19','2015-08-15 08:53:44','code:Jurado.delete;');
INSERT INTO logs VALUES('107','1','1','20','2015-08-15 08:53:44','code:Jurado.delete;');
INSERT INTO logs VALUES('108','1','21','1','2015-08-15 08:53:44',NULL);
INSERT INTO logs VALUES('109','1','18','1','2015-08-15 08:53:44',NULL);
INSERT INTO logs VALUES('110','1','1','22','2015-08-15 08:54:03','code:Comentario.created.add;');
INSERT INTO logs VALUES('111','1','3',NULL,'2015-08-15 14:51:08',NULL);
INSERT INTO logs VALUES('112','1','3',NULL,'2015-08-16 10:45:35',NULL);
INSERT INTO logs VALUES('113','1','1','1','2015-08-16 11:49:18','code:Archivo.created.add;');
INSERT INTO logs VALUES('114','1','1','2','2015-08-16 11:49:30','code:Archivo.created.add;');
INSERT INTO logs VALUES('115','1','1','3','2015-08-16 11:49:35','code:Archivo.created.add;');
INSERT INTO logs VALUES('116','1','1','3','2015-08-16 11:49:41','code:Archivo.delete;');
INSERT INTO logs VALUES('117','1','1','1','2015-08-16 11:49:45','code:Archivo.delete;');
INSERT INTO logs VALUES('118','1','1','2','2015-08-16 11:49:47','code:Archivo.delete;');
INSERT INTO logs VALUES('119','1','1','4','2015-08-16 13:36:40','code:Archivo.created.add;');
INSERT INTO logs VALUES('120','1','1','5','2015-08-16 13:36:43','code:Archivo.created.add;');
INSERT INTO logs VALUES('121','1','1','6','2015-08-16 13:36:46','code:Archivo.created.add;');
INSERT INTO logs VALUES('122','1','1','7','2015-08-16 13:37:18','code:Archivo.created.add;');
INSERT INTO logs VALUES('123','1','3',NULL,'2015-08-16 14:52:59',NULL);
INSERT INTO logs VALUES('124','1','3',NULL,'2015-08-16 17:11:52',NULL);
INSERT INTO logs VALUES('125','1','1','5','2015-08-16 17:12:33','code:Archivo.delete;');
INSERT INTO logs VALUES('126','1','1','7','2015-08-16 17:12:38','code:Archivo.delete;');
INSERT INTO logs VALUES('127','1','1','6','2015-08-16 17:12:40','code:Archivo.delete;');
INSERT INTO logs VALUES('128','1','10','3','2015-08-16 17:14:56',NULL);
INSERT INTO logs VALUES('129','1','11','12','2015-08-16 17:14:56',NULL);
INSERT INTO logs VALUES('130','1','11','13','2015-08-16 17:14:56',NULL);
INSERT INTO logs VALUES('131','1','12','17','2015-08-16 17:14:57',NULL);
INSERT INTO logs VALUES('132','1','13','3','2015-08-16 17:14:57',NULL);
INSERT INTO logs VALUES('133','1','19','10','2015-08-16 17:15:52',NULL);
INSERT INTO logs VALUES('134','1','19','11','2015-08-16 17:15:52',NULL);
INSERT INTO logs VALUES('135','1','20','14','2015-08-16 17:15:52',NULL);
INSERT INTO logs VALUES('136','1','20','15','2015-08-16 17:15:52',NULL);
INSERT INTO logs VALUES('137','1','20','16','2015-08-16 17:15:52',NULL);
INSERT INTO logs VALUES('138','1','1','22','2015-08-16 17:15:53','code:Comentario.delete;');
INSERT INTO logs VALUES('139','1','1','4','2015-08-16 17:15:53','code:Archivo.delete;');
INSERT INTO logs VALUES('140','1','21','2','2015-08-16 17:15:53',NULL);
INSERT INTO logs VALUES('141','1','18','2','2015-08-16 17:15:53',NULL);
INSERT INTO logs VALUES('142','1','1','1','2015-08-16 17:59:53','code:Usuario.updated.add_foto;');
INSERT INTO logs VALUES('143','1','3',NULL,'2015-08-30 16:45:22',NULL);
INSERT INTO logs VALUES('144','1','3',NULL,'2015-08-30 16:47:09',NULL);
INSERT INTO logs VALUES('145','1','3',NULL,'2015-08-30 16:48:23',NULL);
INSERT INTO logs VALUES('146','1','1','1','2015-08-30 17:04:05','code:Usuario.updated.add_foto;');
INSERT INTO logs VALUES('147','1','10','4','2015-08-30 18:16:20',NULL);
INSERT INTO logs VALUES('148','1','11','14','2015-08-30 18:16:20',NULL);
INSERT INTO logs VALUES('149','1','12','18','2015-08-30 18:16:21',NULL);
INSERT INTO logs VALUES('150','1','13','4','2015-08-30 18:16:21',NULL);
INSERT INTO logs VALUES('151','1','1','1','2015-08-30 18:25:04','code:Archivo.created.add;');
INSERT INTO logs VALUES('152','1','1','2','2015-08-30 18:25:15','code:Archivo.created.add;');
INSERT INTO logs VALUES('153','1','1','3','2015-08-30 18:25:24','code:Archivo.created.add;');
INSERT INTO logs VALUES('154','1','1','1','2015-08-30 18:25:28','code:Archivo.delete;');
INSERT INTO logs VALUES('155','1','1','2','2015-08-30 18:25:31','code:Archivo.delete;');
INSERT INTO logs VALUES('156','1','1','3','2015-08-30 18:25:33','code:Archivo.delete;');
INSERT INTO logs VALUES('157','1','1','1','2015-08-30 18:30:29','code:Usuario.updated.add_foto;');
INSERT INTO logs VALUES('158','1','3',NULL,'2015-09-04 17:49:54',NULL);
INSERT INTO logs VALUES('159','1','3',NULL,'2015-09-05 11:49:13',NULL);
...
CREATE TABLE `mensajes` (
  ...
  CONSTRAINT `mensajes_ibfk_1` FOREIGN KEY (`principal_mensaje_id`) REFERENCES `principal_mensajes` (`id`)
...
INSERT INTO mensajes VALUES('32','2','42','','2015-08-15 08:52:32');
INSERT INTO mensajes VALUES('33','11','43','','2015-08-15 08:52:32');
INSERT INTO mensajes VALUES('34','2','44','','2015-08-15 08:52:54');
INSERT INTO mensajes VALUES('35','11','45','','2015-08-15 08:52:55');
INSERT INTO mensajes VALUES('36','2','46','','2015-08-15 08:53:44');
INSERT INTO mensajes VALUES('37','4','47','','2015-08-16 17:14:57');
...
CREATE TABLE `perfils_usuarios` (
  ...
  KEY `usuario_id` (`usuario_id`),
  CONSTRAINT `perfils_usuarios_ibfk_1` FOREIGN KEY (`perfil_id`) REFERENCES `perfils` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_10` FOREIGN KEY (`perfil_id`) REFERENCES `perfils` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_11` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_12` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_13` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_14` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_15` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_16` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_17` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_18` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_2` FOREIGN KEY (`perfil_id`) REFERENCES `perfils` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_3` FOREIGN KEY (`perfil_id`) REFERENCES `perfils` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_4` FOREIGN KEY (`perfil_id`) REFERENCES `perfils` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_5` FOREIGN KEY (`perfil_id`) REFERENCES `perfils` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_6` FOREIGN KEY (`perfil_id`) REFERENCES `perfils` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_7` FOREIGN KEY (`perfil_id`) REFERENCES `perfils` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_8` FOREIGN KEY (`perfil_id`) REFERENCES `perfils` (`id`),
  CONSTRAINT `perfils_usuarios_ibfk_9` FOREIGN KEY (`perfil_id`) REFERENCES `perfils` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
...
CREATE TABLE `planillas` (
  ...
  KEY `proyecto_id` (`proyecto_id`),
  CONSTRAINT `planillas_ibfk_1` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `planillas_ibfk_2` FOREIGN KEY (`principal_planilla_id`) REFERENCES `principal_planillas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `principal_mensajes` (
  ...
  CONSTRAINT `principal_mensajes_ibfk_1` FOREIGN KEY (`tipo_mensaje_id`) REFERENCES `tipo_mensajes` (`id`)
...
INSERT INTO principal_mensajes VALUES('42','4','Alberto Rodriguez ha agregado un Estudiante al Proyecto #1',NULL,'{\"controller\":\"proyectos\",\"action\":\"view\",\"0\":\"1\"}');
INSERT INTO principal_mensajes VALUES('43','5','Lo han invitado a ser parte de un Proyecto, #1',NULL,'{\"controller\":\"proyectos\",\"action\":\"index\"}');
INSERT INTO principal_mensajes VALUES('44','9','Alberto Rodriguez ha revocado la invitacion al Proyecto #1 de un Estudiante',NULL,'{\"controller\":\"proyectos\",\"action\":\"view\",\"0\":\"1\"}');
INSERT INTO principal_mensajes VALUES('45','9','Su invitación al Proyecto #1 ha sido revocada',NULL,NULL);
INSERT INTO principal_mensajes VALUES('46','3','Alberto Rodriguez ha eliminado el Proyecto #1',NULL,NULL);
INSERT INTO principal_mensajes VALUES('47','5','Lo han invitado a ser parte de un Proyecto, #3',NULL,'{\"controller\":\"proyectos\",\"action\":\"indexTutorAcad\"}');
INSERT INTO principal_mensajes VALUES('48','3','Alberto Rodriguez ha eliminado el Proyecto #2',NULL,NULL);
...
CREATE TABLE `principal_planillas` (
  ...
  CONSTRAINT `principal_planillas_ibfk_1` FOREIGN KEY (`tipo_planilla_id`) REFERENCES `tipo_planillas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `programas` (
  ...
  CONSTRAINT `programas_ibfk_1` FOREIGN KEY (`tipo_programa_id`) REFERENCES `tipo_programas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8;

INSERT INTO programas VALUES('1','Ingeniería en Informática','Ingeniero(a) en Informática','1','1');
...
CREATE TABLE `proyectos` (
  ...
  KEY `sede_id` (`sede_id`),
  CONSTRAINT `proyectos_ibfk_1` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `proyectos_ibfk_10` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `proyectos_ibfk_11` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `proyectos_ibfk_12` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `proyectos_ibfk_13` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `proyectos_ibfk_14` FOREIGN KEY (`programa_id`) REFERENCES `programas` (`id`),
  CONSTRAINT `proyectos_ibfk_15` FOREIGN KEY (`sede_id`) REFERENCES `sedes` (`id`),
  CONSTRAINT `proyectos_ibfk_16` FOREIGN KEY (`fase_id`) REFERENCES `fases` (`id`),
  CONSTRAINT `proyectos_ibfk_17` FOREIGN KEY (`fase_id`) REFERENCES `fases` (`id`),
  CONSTRAINT `proyectos_ibfk_18` FOREIGN KEY (`fase_id`) REFERENCES `fases` (`id`),
  CONSTRAINT `proyectos_ibfk_19` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`),
  CONSTRAINT `proyectos_ibfk_2` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `proyectos_ibfk_20` FOREIGN KEY (`grupo_id`) REFERENCES `grupos` (`id`),
  CONSTRAINT `proyectos_ibfk_3` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `proyectos_ibfk_4` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `proyectos_ibfk_5` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `proyectos_ibfk_6` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `proyectos_ibfk_7` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `proyectos_ibfk_8` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `proyectos_ibfk_9` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

INSERT INTO proyectos VALUES('3','adasd','34','11','1','1','1','2015-08-16 17:14:56','2015-08-16 17:14:56','','1');
INSERT INTO proyectos VALUES('4','asdasd',NULL,'5','1','1','1','2015-08-30 18:16:20','2015-08-30 18:16:20','','1');
...
CREATE TABLE `revisions` (
  ...
  KEY `usuario_id` (`usuario_id`),
  KEY `proyecto_id` (`proyecto_id`),
  CONSTRAINT `revisions_ibfk_1` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8;

INSERT INTO revisions VALUES('17','sdasdasd','sdasd','sdasd<br>','sd','','3','2015-08-16 17:14:57','1',NULL);
INSERT INTO revisions VALUES('18','asdasdas','asdasda','asdasd','asdasd','asd','4','2015-08-30 18:16:21','1',NULL);
...
CREATE TABLE `usuarios` (
  ...
  KEY `cedula` (`cedula`),
  KEY `hash` (`hash`),
  CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`tipo_usuario_id`) REFERENCES `tipo_usuarios` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;

INSERT INTO usuarios VALUES('1','16407820','$2a$10$NzxSjApyZ9zhc4qaxazhNuehyeNLdLwDJHAbgUq1CNhykpmyCliuG','Alberto','Rodriguez','M','arod.unerg@gmail.com','1','2','2015-06-05 00:40:34','2015-08-30 18:30:29','2015-08-30 18:30:29','1','1','1','','356a192b7913b04c54574d18c28d46e6395428ab');
